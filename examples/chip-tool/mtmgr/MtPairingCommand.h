...
class MtPairingCommand : public MtCommand,
                         public chip::Controller::DevicePairingDelegate,
                         public chip::Controller::DeviceDiscoveryDelegate,
                         public chip::Credentials::DeviceAttestationDelegate
{
public:
    MtPairingCommand(MatterManagerCore & mtmgrCore, PairingMode mode, PairingNetworkType networkType,
    ...
    {
        return chip::System::Clock::Seconds16(mTimeout.ValueOr(120));
    }
...
private:
    ...
    MtCommand::AddressWithInterface mRemoteAddr;
...
class MtPairOnNetworkLong : public MtPairingCommand
{
public:
    MtPairOnNetworkLong(MatterManagerCore & mtmgrCore, NodeId nodeId, uint32_t setupPINCode, uint16_t discoveryFilterCode) :
        MtPairingCommand(mtmgrCore, PairingMode::OnNetwork, PairingNetworkType::None,
                         chip::Dnssd::DiscoveryFilterType::kLongDiscriminator)
    {
        mNodeId              = nodeId;
        mSetupPINCode        = setupPINCode;
        mDiscoveryFilterCode = discoveryFilterCode;
    }
};
