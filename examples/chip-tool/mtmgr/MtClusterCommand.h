...
class MtClusterCommand : public InteractionModelCommands, public MtModelCommand, public chip::app::CommandSender::Callback
{
public:
    MtClusterCommand(MatterManagerCore & mtmgrCore) : InteractionModelCommands(this), MtModelCommand(mtmgrCore)
    {
#if 0
    ...
    MtClusterCommand(chip::ClusterId clusterId, MatterManagerCore & mtmgrCore) :
        InteractionModelCommands(this), MtModelCommand(mtmgrCore), mClusterId(clusterId)
    {
#if 0
        AddByIdArguments();
        AddArguments();
